 ...
 */
public class ClickableAdapter extends SimpleAdapter {
    private List<? extends Map<String, ?>> data;

    public ClickableAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
