...
public class ModelUser implements Parcelable
{
    ...
    protected ModelUser(Parcel in) {
        ...
        this.personalEmail = ((String) in.readValue((String.class.getClassLoader())));
        this.r2w = ((Object) in.readValue((Object.class.getClassLoader())));
        this.hmrc = ((Object) in.readValue((Object.class.getClassLoader())));
        this.poa = ((Object) in.readValue((Object.class.getClassLoader())));
        this.dbs = ((Object) in.readValue((Object.class.getClassLoader())));
        ...
        this.visaStatus = ((String) in.readValue((String.class.getClassLoader())));
        this.medicalConditions = ((String) in.readValue((String.class.getClassLoader())));
        this.languagesSpoken = ((String) in.readValue((String.class.getClassLoader())));
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(dob);
        dest.writeValue(personalEmail);
        dest.writeValue(r2w);
        dest.writeValue(hmrc);
        dest.writeValue(poa);
        dest.writeValue(dbs);
        dest.writeValue(maritalStatus);
        dest.writeValue(nationality);
        dest.writeValue(visaStatus);
        dest.writeValue(medicalConditions);
        dest.writeValue(languagesSpoken);
